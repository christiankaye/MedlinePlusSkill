...
class TestAll(unittest.TestCase):
    ...
    def test_submit_query(self):
        ...
        self.assertEqual(search_form.fields['query'].get('value'), 'bursitis')

    def test_crawler_scraper_methods(self):
        c = Crawler()
        c.logging = True
        c.useragent = "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)"
        c.open("https://vsearch.nlm.nih.gov/vivisimo/cgi-bin/query-meta?v%3Aproject=medlineplus&v%3Asources=medlineplus-bundle&query=bursitis")
